...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/viscomplexr)](https://cran.r-project.org/package=viscomplexr)
<!-- badges: end -->
...
```{r, echo=FALSE}
knitr::include_graphics("_pkgdown/figure_banner_300dpi.png")
```
<br>    
...
The released version of *viscomplexr* can be installed from [CRAN](https://CRAN.R-project.org/package=viscomplexr) with:
