...
```{r figure9, fig.width=7, fig.height=7, fig.show='hold', results='hide', cache=TRUE}
op <- par(mfrow = c(3, 3), mar = c(0.2, 0.2, 0.2, 0.2), oma = c(0, 2.1, 2.1, 0))
for(lb in c(1, 4, 9)) {
  for(dS in c(0, 0.2, 0.6)) {
