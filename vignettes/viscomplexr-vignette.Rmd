...
```{r figure_15, fig.width=7, fig.height=7*9/16, fig.align='center', results='hide', fig.show='hold', cache=TRUE, fig.cap='A phase portrait that fully covers a graphics device (see example code above).'}
# Assume graphics device with 16/9 aspect ratio is already open
...
```{r figure_16, fig.width=7, fig.height=7*9/16, fig.align='center', results='hide', fig.show='hold', cache=TRUE, fig.cap='Phase portrait with frame. Fine tuning is required for obtaining a uniform frame width (see code example above).'}
# Assume graphics device with 16/9 aspect ratio and a width of 7 inches 
#   is already open
...
X auch Rahmen (wie bei Heinz 70)
